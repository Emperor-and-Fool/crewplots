import { pgTable, text, serial, integer, boolean, timestamp, json, foreignKey, varchar, decimal, jsonb, index } from "drizzle-orm/pg-core";
...
export const replit_users = pgTable("replit_users", {
